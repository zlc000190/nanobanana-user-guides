# Nano Banana safe fallback decision tree
...
Define the ordered response for unavailable dependencies, incomplete outputs, stale evidence, policy conflicts, and exceeded cost or time limits. Base choices on licensed reference images, saved prompts, model settings, artifact checks, and retention rules.
