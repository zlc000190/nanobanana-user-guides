# Nano Banana scope and success contract
...
Write a one-page contract for the exact workflow under review. Name the authorized input, intended user, supported environment, excluded actions, output format, acceptance threshold, stop conditions, and accountable reviewer. Attach licensed reference images, saved prompts, model settings, artifact checks, and retention rules.
